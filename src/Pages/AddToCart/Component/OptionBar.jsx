...
export default function OptionBar({name, desc}) {
  return (
    <>
        <Box className="toolbar">
            <Stack direction="column" spacing={1} sx={{height:"300px",backgroundColor:" black",opacity: 0.7}} justifyContent="center" alignItems={"center"}>
                <Typography sx={{color:"white",}} align="center" variant="h3" component="h4">{name}</Typography>
                <Stack direction="row" spacing={1}  justifyContent="center">
                    ...
                    <Typography sx={{color:"white"}}  variant="body1" component="p">{desc} </Typography>
                </Stack>
            </Stack>
        </Box>
    </>
